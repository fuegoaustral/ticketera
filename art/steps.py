...
class Step:
    ...
    def missing_count(self):
        """'Falta 1 campo' / 'Faltan 3 pasos': Carta y Checkout son pasos a hacer, el resto son campos."""
...
STEPS = (
    ...
    ('carta', 'Carta de entendimiento', 'Carta', 'understanding_letter', False,
     'Firmás la carta, subís una foto o un PDF y entregás la copia física.'),
...
def _letter_state(program, at):
    """La carta tiene dos plazos: digital y copia física. Está abierta mientras alguno lo esté."""
...
def _missing(key, artwork):
    ...
    if key == 'carta':
        ...
        if not artwork.understanding_letter:
            missing.append('Subir la carta firmada')
