...
| `attended_events` | `{"event_ids": [14, 7, 4, 1], "min_count": 2}` | Dueño de un bono en **al menos** `min_count` eventos distintos de la lista. `must_be_used` default `true` (ingreso escaneado). |
