...
- Condición `attended_events`: owner o holder de un bono en al menos `min_count` de los `event_ids`; `must_be_used` default true. Si es false, también cuenta órdenes CONFIRMED.
