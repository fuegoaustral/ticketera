...
6. El checkout se habilita en la apertura de checkout del programa o, si no tiene fecha, cuando empieza el evento: las instalaciones activas pasan a **Checkout pendiente**. El equipo sube fotos del estado final y envía el checkout (**Checkout enviado**); el equipo de Arte lo verifica en el predio (**Checkout verificado**).
